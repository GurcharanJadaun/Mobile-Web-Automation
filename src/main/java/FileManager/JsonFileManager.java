...
public class JsonFileManager {
	...
	public JsonFileManager(String dir) {
		this.pathSep = File.separator;
		this.dir = System.getProperty("user.dir") + pathSep + dir;
	}

	/**
	 * returns Iterator<JsonNode> from the json file read. Will be used against JSON
	 * array files. Doesn't need ".json" extension in file name.
	 * 
	 * @param "filename"
	 */
	public Iterator<JsonNode> getItemsFromJson(String fileName) throws IOException {
		ObjectMapper objectMapper = new ObjectMapper();
		JsonNode jsonNode = objectMapper.readTree(new File(this.dir + this.pathSep + fileName + ".json"));
